...
,so.CustomerShorName,so.SOCustomerOrder
,CONVERT(INT,so.OrderByQtyTU) SOQuantity
...
,b.OrderByQtyTU
,b.DescFlexField_PubDescSeg3 SOCustomerOrder
,a.OrderBy_ShortName CustomerShorName
...
AND a.org=1001708020135665 ---(SELECT id FROM dbo.Base_Organization WHERE code='300')
