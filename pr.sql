...
INSERT INTO #SOList
SELECT 'SO短缺关闭，PR未关闭',*  FROM SOList
...
WHERE a.DocNo IN (SELECT * FROM PRNo) AND a.DemandCode<>-1 AND (b.Line_Status='自然关闭' OR b.DocNo IS NULL)
)
INSERT INTO #SOList
SELECT 'SO自然关闭，PR未关闭',* FROM PRR

INSERT INTO #SOList       
  SELECT '手工PR','','','','',null,null,'','','',* FROM #PR WHERE DemandCode=-1
